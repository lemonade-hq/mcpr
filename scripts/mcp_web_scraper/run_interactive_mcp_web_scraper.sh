...
# Build the example
echo -e "${BLUE}${BOLD}Building interactive MCP web scraper...${NC}"
cargo build --example interactive_mcp_web_scraper
...
echo -e "${BLUE}${BOLD}Running interactive MCP web scraper...${NC}"
cargo run --example interactive_mcp_web_scraper
